function editData(){
  $('.editbutton').html("<button type='button' style='float:right; margin-left:5px;' class='tiny button' onclick='cancelButton()' >Cancel</button>"+
    "<button type='button' style='float:right;' class='tiny button' onclick='' >Submit</button>");
...
function cancelButton(){
  $('.editbutton').html("<button type='button' style='float:right;' class='tiny button' onclick='editData()' >Edit</button>");
